...
public class PostJournalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView addPhotoButton; //The camera icon in the xml
    private ImageView imageView; //background image in xml
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton = findViewById(R.id.post_journal_save_button);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.post_journal_save_button:
                //save Journal
                saveJournal();
                break;
